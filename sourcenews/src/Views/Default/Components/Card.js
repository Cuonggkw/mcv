  ...
  handleToggle = (e) => {
    if (Object.keys(this.props.stateUser).length <= 0) {
      ...
      if (
        ...
        this.props.onClick &&
        this.props.onClick == "handleToggleModalApply"
      ) {
    ...
    return (
      <>
        <div
          className={
            "nl-card " +
            (this.props.type && this.props.type == "horizontal"
              ? " horizontal"
              : "") +
            (this.props.backgroundBody ? this.props.backgroundBody + " bg" : "")
          }
        >
                    ...
                    <div onClick={this.handleToggle}>
                      <Button type="submit" variant="contained"
                        ...
                        disabled={
                          loading == true
                            ? true
                            : this.props.openCasting != 1
                            ? true
                            : false
                        }
                      >
                        {this.props.openCasting == 1 ? "OK" : "Disable"}
                        {loading == true && (
              ...
              <div className="date">
                {loading ? (
                  ...
                  <>
                    {this.props.date && (
                      <span>
                        <TimeAgo datetime={this.props.date} locale="vi" />
                      </span>
                    )}
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    {this.props.createdTime && (
                      <span>
                        <TimeAgo
                          datetime={this.props.createdTime}
                          locale="vi"
                        />
                      </span>
                    )}
